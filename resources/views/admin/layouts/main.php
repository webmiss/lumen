...
?>
			<li><a href="<?php echo Inc::getUrl(MODULE.'/'.$val->url);?>" class="<?php echo $an;?>"><em class="<?php echo $val->ico;?>"></em><span><?php echo $val->title;?></span></a></li>
<?php }?>
		</ul>
		<div class="top_link">
			...
			<span class="icon user">
				...
				<span class="info">
					...
					<a href="<?php echo Inc::getUrl(MODULE.'/index/loginOut');?>" class="btop center">注销</a>
				</span>
			</span>
		</div>
	</div>
...
?>
				<li><a href="<?php echo Inc::getUrl(MODULE.'/'.$val2->url);?>" class="<?php echo $an;?>"><?php echo $ico;?><span><?php echo $val2->title;?></span></a></li>
<?php }}?>
			</ul>
<?php }?>
		</div>
